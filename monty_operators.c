...
if (length < 2)
{
fprintf(stderr, "L%d: cant add, stack too shortn, counter);
fclose(bus.file);
free(bus.content);
free_stack(*head);
exit(EXIT_FAILURE);
...
if (length < 2)
{
fprintf(stderr, "L%d: cant mul, stack too shortn, counter);
fclose(bus.file);
free(bus.content);
free_stack(*head);
exit(EXIT_FAILURE);
...
if (length < 2)
{
fprintf(stderr, "L%d: cant mod, stack too shortn, counter);
fclose(bus.file);
free(bus.content);
free_stack(*head);
exit(EXIT_FAILURE);
...
if (nd < 2)
{
fprintf(stderr, "L%d: cant sub, stack too shortn, counter);
fclose(bus.file);
free(bus.content);
free_stack(*head);
exit(EXIT_FAILURE);
...
if (length < 2)
{
fprintf(stderr, "L%d: cant div, stack too shortn, counter);
fclose(bus.file);
free(bus.content);
free_stack(*head);
exit(EXIT_FAILURE);
